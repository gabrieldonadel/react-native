...
RCT_REMAP_SHADOW_PROPERTY(marginInlineStart, marginStart, YGValue)
RCT_REMAP_SHADOW_PROPERTY(marginInlineEnd, marginEnd, YGValue)
RCT_REMAP_SHADOW_PROPERTY(marginBlockStart, marginTop, YGValue)
RCT_REMAP_SHADOW_PROPERTY(marginBlockEnd, marginBottom, YGValue)
...
RCT_REMAP_SHADOW_PROPERTY(paddingInlineStart, paddingStart, YGValue)
RCT_REMAP_SHADOW_PROPERTY(paddingInlineEnd, paddingEnd, YGValue)
RCT_REMAP_SHADOW_PROPERTY(paddingBlockStart, paddingTop, YGValue)
RCT_REMAP_SHADOW_PROPERTY(paddingBlockEnd, paddingBottom, YGValue)
